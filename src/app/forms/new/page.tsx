          ...
          <>
            ...
            {currentStep === STEP_WHITELIST && (
              <div className="anim-in space-y-4">
                <div className="rounded-2xl border border-neutral-100 bg-neutral-50 p-6 md:p-8 space-y-5">
                  <div>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white border border-neutral-200">
                    ...
                    <button type="button" role="switch" aria-checked={whitelist.enabled}
                  ...
                  {whitelist.enabled && (
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <select value={whitelist.identifierLabel}
                      ...
                      <div>
                        ...
                        <textarea value={whitelistRaw} onChange={(e) => setWhitelistRaw(e.target.value)} rows={8}
            ...
            {currentStep >= STEP_QUESTIONS_START && (() => {
              ...
              return (
                <div key={q.id} className="anim-in rounded-2xl border border-neutral-100 bg-white p-6 md:p-8 shadow-sm space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input type="text" value={q.label} onChange={(e) => updateQuestion(q.id, { label: e.target.value })}
                        className="w-full px-4 py-2.5 rounded-xl border border-neutral-200 text-neutral-900 text-sm transition-all focus:ring-1 focus:ring-neutral-300"
                        placeholder="Enter your question…" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                    </div>
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        <input type="checkbox" id={`req-${q.id}`} checked={q.required}
                          onChange={(e) => updateQuestion(q.id, { required: e.target.checked })} className="rounded border-neutral-300" />
                          ...
                          {(q.options ?? []).map((opt, i) => (
                            <div key={i} className="flex items-center gap-2">
                              ...
                              <input type="text" value={opt} onChange={(e) => updateOption(q.id, i, e.target.value)}
                                className="flex-1 px-3 py-2 rounded-lg border border-neutral-200 text-sm text-neutral-900 focus:ring-1 focus:ring-neutral-300"
                                placeholder={`Option ${i + 1}`} style={{ fontFamily: "'DM Sans', sans-serif" }} />
                    ...
                    {(q.type === "scale" || q.type === "slider" || q.type === "number") && (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <input type="number" value={q.min ?? 1} min={0}
                            onChange={(e) => updateQuestion(q.id, { min: parseInt(e.target.value) })}
                            className="w-full px-3 py-2 rounded-xl border border-neutral-200 text-sm text-center focus:ring-1 focus:ring-neutral-300"
                            style={{ fontFamily: "'DM Sans', sans-serif" }} />
                        </div>
                        <div>
                          ...
                          <input type="number" value={q.max ?? 10} min={1}
                        ...
                        {(q.type === "slider" || q.type === "number") && (
                          <div>
                            ...
                            <input type="number" value={q.step ?? 1} min={0.01} step={0.01}
